	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				types: [],
				path: "/Information",
				shadow: () => import('./entries/endpoints/Information/index.ts.js'),
				a: [0,5],
				b: [1]
			},
			{
			...
			},
			{
				...
				shadow: () => import('./entries/endpoints/Referensuppdrag/index.ts.js'),
				a: [0,8],
				b: [1]
			},
			{
			...
			},
			{
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/Login/logout/index.ts.js')
			},
			{
				type: 'page',
				id: "Login/login",
				...
				types: [],
				path: "/Login/login",
				shadow: () => import('./entries/endpoints/Login/login/index.ts.js'),
				a: [0,10],
				b: [1]
			},
			{
				...
				types: [],
				path: "/Login/register",
				shadow: () => import('./entries/endpoints/Login/register/index.ts.js'),
				a: [0,11],
				b: [1]
			}
		],
